...
def flood_severity(GFMS_Table,GloFas_Table,adate):
    ...
    # outputs file
    Final_Attributes_csv = os.path.join(settings.GFMS_MOM_DIR ,'Final_Attributes_{}.csv'.format(adate))
    ...
    with open(GloFas_Table, 'r', encoding='UTF-8') as GloFas_file:
        ...
        GloFas_w_score_csv = os.path.join(settings.GFMS_PROC_DIR,"GloFas_w_score_{}.csv".format(adate))
        GloFas_Error_csv = os.path.join(settings.GFMS_PROC_DIR,"GloFas_Error_{}.csv".format(adate))
    ...
    GloFas_w_score_sort_csv = os.path.join(settings.GFMS_PROC_DIR,"GloFas_w_score_sort_{}.csv".format(adate))
    GloFas.set_index('pfaf_id').to_csv(GloFas_w_score_sort_csv, encoding='utf-8')

    with open(GloFas_w_score_sort_csv, 'r') as GloFas_file:
        GloFas_reader = csv.reader(GloFas_file)
        GloFas_w_Avgscore_csv = os.path.join(settings.GFMS_PROC_DIR,"GloFas_w_Avgscore_{}.csv".format(adate))
    ...
    PDC_resilience = read_data(os.path.join(settings.BASE_DIR,'data','Resilience_Index.csv'))
